...
import { Animated, Dimensions, Platform, ViewPagerAndroid } from 'react-native';
    ...
    function Tabs(props) {
        ...
        _this.renderContent = function () {
            ...
            var _this$props = _this.props,
                ...
                tabBarContentViewStyle = _this$props.tabBarContentViewStyle;
            ...
            if (Platform.OS === 'android') {
                return React.createElement(
                    ...
                    { key: '$content', keyboardDismissMode: 'on-drag', initialPage: currentTab, scrollEnabled: _this.props.swipeable || usePaged, onPageScroll: function onPageScroll(e) {
                        ...
                        }, style: _extends({ flex: 1 }, tabBarContentViewStyle), onPageSelected: function onPageSelected(e) {
